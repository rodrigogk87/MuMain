...
#define ITEM_SWORD_CRYSTAL_KNIGHT	(ITEM_SWORD + 100)
#define ITEM_SHIELD_CRYSTAL_KNIGHT	(ITEM_SHIELD + 100)
inline bool IsCrystalKnightItemType(int type)
{
    return type == ITEM_HELM + CRYSTAL_KNIGHT_SET_INDEX || type == ITEM_ARMOR + CRYSTAL_KNIGHT_SET_INDEX
        ...
        || type == ITEM_SWORD_CRYSTAL_KNIGHT || type == ITEM_SHIELD_CRYSTAL_KNIGHT;
}
